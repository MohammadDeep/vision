...
from vision.modeles import dic_model_8


model_name= dic_model_8['model_name']
model_stucher = dic_model_8['model_stucher']
...
# ImageFolder دو کلاس را 0 و 1 نگاشت می‌کند
from vision.Config import dir_dataset_orgnal
